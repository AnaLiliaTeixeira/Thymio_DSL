...
/**
 * This is the item provider adapter for a {@link thymio_DSL.ArithmeticExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArithmeticExpressionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addOperatorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				Thymio_DSLPackage.Literals.ARITHMETIC_EXPRESSION__OPERATOR, true, false, false,
	...
	protected void addRightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ArithmeticExpression_right_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_ArithmeticExpression_right_feature",
						"_UI_ArithmeticExpression_type"),
				Thymio_DSLPackage.Literals.ARITHMETIC_EXPRESSION__RIGHT, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addLeftPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ArithmeticExpression_left_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_ArithmeticExpression_left_feature",
						"_UI_ArithmeticExpression_type"),
				Thymio_DSLPackage.Literals.ARITHMETIC_EXPRESSION__LEFT, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((ArithmeticExpression) object).getOperator();
