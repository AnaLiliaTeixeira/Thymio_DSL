...
/**
 * This is the item provider adapter for a {@link thymio_DSL.Condition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConditionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Condition_operator_feature",
								"_UI_Condition_type"),
						Thymio_DSLPackage.Literals.CONDITION__OPERATOR, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Thymio_DSLPackage.Literals.CONDITION__RIGHT_SENSOR);
			childrenFeatures.add(Thymio_DSLPackage.Literals.CONDITION__LEFT_SENSOR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Thymio_DSLPackage.Literals.CONDITION__RIGHT_SENSOR,
				Thymio_DSLFactory.eINSTANCE.createSensor()));

		newChildDescriptors.add(createChildParameter(Thymio_DSLPackage.Literals.CONDITION__LEFT_SENSOR,
				Thymio_DSLFactory.eINSTANCE.createSensor()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == Thymio_DSLPackage.Literals.CONDITION__RIGHT_SENSOR
				|| childFeature == Thymio_DSLPackage.Literals.CONDITION__LEFT_SENSOR;
