	...
	public NotificationChain basicSetCondition(Condition newCondition, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Thymio_DSLPackage.IF_STATEMENT__CONDITION, oldCondition, newCondition);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Thymio_DSLPackage.IF_STATEMENT__CONDITION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Thymio_DSLPackage.IF_STATEMENT__CONDITION,
