...
public class TDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getUpperEventAccess().getGroup_1(), "rule__UpperEvent__Group_1__0");
			...
			builder.put(grammarAccess.getUpperEventAccess().getButtonAssignment_0(), "rule__UpperEvent__ButtonAssignment_0");
			builder.put(grammarAccess.getUpperEventAccess().getButtonAssignment_1_1(), "rule__UpperEvent__ButtonAssignment_1_1");
			builder.put(grammarAccess.getUpperEventAccess().getStateAssignment_3(), "rule__UpperEvent__StateAssignment_3");
			builder.put(grammarAccess.getButtonAccess().getNameAssignment(), "rule__Button__NameAssignment");
			builder.put(grammarAccess.getProxEventAccess().getSensorAssignment(), "rule__ProxEvent__SensorAssignment");
